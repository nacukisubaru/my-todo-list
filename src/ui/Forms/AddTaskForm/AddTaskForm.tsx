    ...
    return (
        <div className="border-solid border-2 border-indigo-600 rounded-xl h-auto">
            <div className="display grid px-[7px] py-[7px] mb-[18px]">
                <input type="text" className="hover:outline-none hover:outline-offset-0 active:outline-none active:outline-offset-0 focus:outline-none focus:outline-offset-0" placeholder={inputPlaceHolder}/>
                <textarea className="resize-none h-[70px] hover:outline-none hover:outline-offset-0 active:outline-none active:outline-offset-0 focus:outline-none focus:outline-offset-0" placeholder={textPlaceHolder}></textarea>
            </div>
            <div className="display flex justify-end mx-[7px] my-[7px]">
                ...
                <BasicButton name={primaryButtonName} color="primary" onClick={primaryButtonClick}/>
            </div>
        </div>
    );
};
