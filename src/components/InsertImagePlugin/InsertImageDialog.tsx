...
export const InsertImageDialog = (props: {
    ...
    const onInsert = () => {
        ...
        const attrs = Object.keys(data)
            ...
            .reduce(
                (acc, curr) => Object.assign(acc, { [curr]: data[curr] }),
                {}
            );
    ...
    const [visibleImagesSelect, setVisibleImagesSelect] =
    ...
    return ReactDOM.createPortal(
        ...
        >
            {visibleImagesSelect && (
                <UploadedImagesSelect
                    show={visibleImagesSelect}
                    onClose={closeUploadedImagesSelect}
                    callbackSelectFile={setFileLink}
                />
            )}
            <TabStrip
                selected={selected}
            ...
            >
                {Object.entries(attrs).length === 0 && (
                    <TabStripTab title="By URL">
                        <Button onClick={showUploadedImagesSelect}>
                            Загрузить с сервера
                        </Button>
